package com.example.myproject.ui.theme.screens.events
...
import com.example.myproject.navigation.ROUTE_UPDATE_EVENT
...
@Composable
fun FindEventsScreen(navController: NavHostController){
...
fun FindEventsScreenpreview(){
    FindEventsScreen(rememberNavController())
}